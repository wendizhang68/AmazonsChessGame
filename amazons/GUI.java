...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Game->AutoW", this::autoWhite);
        addMenuButton("Game->ManualW", this::manualWhite);
        addMenuButton("Game->AutoB", this::autoBlack);
        addMenuButton("Game->ManualB", this::manualBlack);
